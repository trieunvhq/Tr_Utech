...
{
    public partial class XK_CKPage : ContentPage
    {
        //MyScan _MyScan; 

        public XK_CKPageModel ViewModel { get; set; }
        public XK_CKPage()
        {
            InitializeComponent();
            ...
            ViewModel = new XK_CKPageModel();
            ViewModel.Initialize();
            BindingContext = ViewModel;
            ViewModel._XK_CKPage = this;
            //_MyScan = new MyScan();
            //_MyScan._XK_CKPageModel = ViewModel;
        ...
        async void BtnLuuLai_CLicked(System.Object sender, System.EventArgs e)
        {
            await Controls.LoadingUtility.ShowAsync().ContinueWith(async a =>
            {
                Device.BeginInvokeOnMainThread(async () =>
                {
                    await Xamarin.Forms.Application.Current.MainPage.Navigation.PushAsync(new XK_XKDCPage(
        ...
        void BtnQuet_CLicked(System.Object sender, System.EventArgs e)
        {
            ...
            {
                MySettings.InsertLogs(0, DateTime.Now, "BtnQuet_CLicked", ee.Message, "XK_CKPage", MySettings.UserName);
