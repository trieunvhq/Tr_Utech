...
{
    public partial class XKDC_ScanQRPage : ContentPage
    { 
        public XKDC_ScanQRViewModel ViewModel { get; set; }
        public XKDC_ScanQRPage(string id, string no, DateTime d)
        {
            InitializeComponent();
            ...
            ViewModel = new XKDC_ScanQRViewModel(id, no, d); 
