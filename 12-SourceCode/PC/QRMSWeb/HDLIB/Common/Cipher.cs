...
namespace HDLIB.Common
{
    public class Cipher
    {
        ...
        public static byte[] AES_Decrypt(byte[] bytesToBeDecrypted, byte[] passwordBytes)
        {
            ...
            // Set your salt here, change it to meet your flavor: 
            // The salt bytes must be at least 8 bytes.
            // salt nhất định phải có ít nhất 8 bytes
            byte[] saltBytes = new byte[] { 1, 2, 3, 4, 5, 6, 7, 8 };
        ...
        public static string EncryptText(string input, string password = "KeyCipher@PJICO")
        {
        ...
        public static string DecryptText(string input, string password = "KeyCipher@PJICO")
        {
            // Get the bytes of the string
