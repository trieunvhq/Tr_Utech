...
namespace QRMSWeb.Services
{
    public class TransferDirectiveService : APIService
    {
        ...
        public async Task<PaginateData<List<PurchaseOrderItemModel>>> SearchImportDirective(int page, int rowPerPage,
        ...
        public async Task<PaginateData<List<PurchaseOrderItemModel>>> ImportDirectiveActualScanDetail(int page, int rowPerPage,
        ...
        public async Task<ResponseData<Object>> ImportImportDirective()
        {
        ...
        public async Task<PurchaseOrderModel> GetImportDirectiveByID(int purchaseOrderID)
        {
