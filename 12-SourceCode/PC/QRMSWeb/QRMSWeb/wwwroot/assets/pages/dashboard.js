...
!function($) {
    ...
    Dashboard.prototype.init = function() {
       ...
       // 20210805 - rem - error js: this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#ccc', '#f5b225', '#1b82ec']);
       ...
       // 20210805 - rem - error js: this.createDonutChart('morris-donut-example', $donutData, ['#f0f1f4', '#1b82ec', '#f5b225']);
