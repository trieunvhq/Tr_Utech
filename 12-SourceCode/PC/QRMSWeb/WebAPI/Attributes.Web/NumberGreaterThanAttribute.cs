...
namespace Web_API.Attributes.Web
{
    ...
    public class NumberGreaterThanAndEqualAttribute : ValidationAttribute
    {
        private string DateToCompareFieldName { get; set; }
        private string ErrorMessage { get; set; }

        public NumberGreaterThanAndEqualAttribute(string DateToCompareFieldName, string ErrorMessage = null)
        {
