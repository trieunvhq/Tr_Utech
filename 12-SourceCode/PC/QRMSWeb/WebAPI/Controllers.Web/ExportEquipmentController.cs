using BLL.Factory.Web.ExportEquipment;
using HDLIB;
using HDLIB.Common;
...
{
    public class ExportEquipmentWebController : BaseAPIController
    {
        ...
        [AuthRequire]
        [PJICOAuthorize]
        [Route("api-wa/export-equipment/find-all-export-equipment")]
            ...
            DateTime? startDate = null,  DateTime? endDate = null)
        {
            ...
            try
            {
                ...
                _return.data = new ExportEquipmentBLL().FindAllExportEquipment(page, limit, itemCode, orderNo, wareHouseCode, startDate, endDate);
