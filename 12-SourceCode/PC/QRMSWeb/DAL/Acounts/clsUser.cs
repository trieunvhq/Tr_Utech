...
namespace DAL
{
	...
	public partial class clsUser : clsDBInteractionBase
	{
		...
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[Tr_User_Insert]";
			...
			catch(Exception ex)
			{
				...
				throw new Exception("clsUser::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[Tr_User_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsUser::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[Tr_User_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsUser::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[Tr_User_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsUser::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[Tr_User_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("User");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsUser::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
