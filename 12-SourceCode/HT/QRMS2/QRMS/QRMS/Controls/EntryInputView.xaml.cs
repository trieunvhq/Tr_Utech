...
namespace QRMS.Controls
{
    public partial class EntryInputView : StackLayout
    {
        ...
        protected override void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            ...
            //    //if (TTSpecicalChar == 1)
            //    //{
            //    //    inputEntry.Behaviors.Add(new SpecialCharactersValidationBehavior());
            //    //}
            //    //else if (TTSpecicalChar == 2)
            //    //{
            //    //    inputEntry.Behaviors.Add(new SpecialCharactersValidationBehavior2());
            //    //}
            //    //else if (TTSpecicalChar == 3)
            //    //{
            //    //    inputEntry.Behaviors.Add(new SpecialCharactersValidationBehavior3());
            //    //}
            //    //else if (TTSpecicalChar == 10)
            //    //{
            //    //    inputEntry.Behaviors.Add(new SpecialCharactersValidationBehavior_CMT());
            //    //}
            //    //else if (TTSpecicalChar == 11)
            //    //{
            //    //    inputEntry.Behaviors.Add(new SpecialCharactersValidationBehavior_MST());
            //    //}
            //    //else
            //    //{
