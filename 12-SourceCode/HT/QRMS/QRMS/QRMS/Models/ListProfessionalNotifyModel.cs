...
{
    public class ListProfessionalNotifyModel : INotifyPropertyChanged
    {
        private decimal _ID;
        public decimal ID { get => _ID; set { _ID = value; OnPropertyChanged();  } }

        private decimal _NOTIFY_ID;
        public decimal NOTIFY_ID { get => _NOTIFY_ID; set {  _NOTIFY_ID = value; OnPropertyChanged(); } }
        ...
        private string _CONTRACT_ALTER_CODE;
        public string CONTRACT_ALTER_CODE { get => _CONTRACT_ALTER_CODE; set { _CONTRACT_ALTER_CODE = value; OnPropertyChanged(); } }
        ...
        private string _NOTIFY_SHOW;
        public string NOTIFY_SHOW
        {
            get => _NOTIFY_SHOW;
            set
            {
        ...
        public int? AGENT_ID { get => _AGENT_ID; set { _AGENT_ID = value; OnPropertyChanged(); } }
