...
{
    public class DiseaseAlterHistoryModel
    {
        ...
        public decimal? OLD_HEALTH_DISEASE_INSURED_VAL { get; set; } // Bệnh hiểm nghèo
        public decimal? NEW_HEALTH_DISEASE_INSURED_VAL { get; set; }


        public decimal? OLD_HEALTH_DISEASE_PRICE { get; set; }
        public decimal? NEW_HEALTH_DISEASE_PRICE { get; set; }
        public decimal? OLD_HEALTH_DISEASE_DE_PRICE { get; set; }
        public decimal? NEW_HEALTH_DISEASE_DE_PRICE { get; set; }
